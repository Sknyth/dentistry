  ...
  return (
    <div className="bg-white rounded-3xl p-6 md:p-10 flex flex-col md:flex-row items-center gap-6 md:gap-8">
      <div className="flex flex-col gap-4 flex-1">
        ...
        <button className="mt-2 md:mt-4 bg-[#8900F2] text-white font-semibold text-base md:text-lg px-6 md:px-8 py-3 md:py-4 rounded-2xl hover:bg-[#7000cc] transition-colors cursor-pointer w-fit">
          Informează-te
        </button>
      </div>
