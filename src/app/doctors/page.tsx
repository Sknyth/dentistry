...
export default function page() {
	return (
		<main className="min-h-screen p-20 flex flex-col gap-8">
			<div className="flex flex-col gap-8 mx-auto">

				<h1 className="text-3xl text-[#8900F2] font-bold">Echipa</h1>
			</div>

			<section className="gap-8 flex flex-col max-w-6xl mx-auto bg-[#8900F2] p-20 rounded-2xl shadow-lg w-full">
